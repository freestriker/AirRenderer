...
NormalShader::NormalShader():Shader()
{
	...
	//this->shaderPasses = std::vector<ShaderPass>(1);
	//this->shaderPasses[0].passName = "Color Pass";
	//this->shaderPasses[0].vertexShading = std::bind(&NormalShader::VertexShading, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
	...
	this->shaderPasses = std::vector<ShaderPass>(1);
	this->shaderPasses[0].vertexShading = std::bind(&NormalShader::DefaultVertexShading, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
	this->shaderPasses[0].pixelShading = std::bind(&NormalShader::WireframePixelShading, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
	this->shaderPasses[0].geometryShading = std::bind(&NormalShader::WireframeGeometryShading, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);
